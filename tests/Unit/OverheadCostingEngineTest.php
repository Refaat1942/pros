...
class OverheadCostingEngineTest extends TestCase
{
    ...
    public function test_calculates_overheads_and_net_offer_with_company_discount(): void
    {
        ...
        $this->assertSame(10000.0, $result['wac_total']);
        ...
        $this->assertSame(20000.0, $result['gross_before_discount']);
        $this->assertSame(20.0, $result['discount_percent']);
        $this->assertSame(4000.0, $result['discount_amount']);
        $this->assertSame(16000.0, $result['net_offer_total']);
    }

    public function test_gross_before_discount_doubles_wac_with_default_rates(): void
    {
        $gross = app(OverheadCostingEngine::class)->grossBeforeDiscount(400);

        $this->assertSame(800.0, $gross);
    }
}
