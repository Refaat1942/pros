...
<div class="section-view" id="section-returns">
    ...
    <div class="admin-returns-banner">
        ↩️ <span><strong>مراقبة ارتجاع المواد (قراءة فقط):</strong> تعرض هذه الصفحة كل إذونات الارتجاع من الورشة إلى المخزن والأصناف التي استُعيدت فعلياً بالباركود.</span>
    </div>
