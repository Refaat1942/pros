<div class="bi-grid" data-static-ui="1">
    <div class="bi-card">
    ...
    <div class="bi-card">
        ...
        <div class="bi-card-body">
            ...
            <div class="bi-sub">🐌 أصناف راكدة (&gt;180 يوم):
                <ul class="bi-list"><li>لا يوجد ✅</li></ul>
            </div>
        </div>
    </div>
    <div class="bi-card">
        ...
        <div class="bi-card-body">
            <div class="bi-row"><span>أوامر التشغيل المفتوحة</span><strong style="color:#7c3aed">0</strong></div>
