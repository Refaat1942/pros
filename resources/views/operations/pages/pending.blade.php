<div class="section-view" id="section-pending">
  ...
  <div class="panel inventory-wrap">
    ...
    <p style="padding:0 24px 12px;margin:0;color:var(--text-muted);font-size:13px;line-height:1.7;">
      طابور الحالات التي وصلت بعروض أسعار صادرة. يمكنك <strong>طباعة عرض السعر</strong> وتسليمه للعميل،
      ثم <strong>الموافقة واعتماد الصرف</strong> (حجز فوري للمواد) أو <strong>الإرجاع للتعديل</strong>
      على المعدلات أو التوصيف الفني.
    </p>
