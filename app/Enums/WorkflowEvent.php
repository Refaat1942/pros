...
enum WorkflowEvent: string
{
    ...
    case ServicesApprovalRequired = 'services_approval_required'; // cost_calc → services_approval
    case ServicesApproved = 'services_approved';    // services_approval → operations
    ...
    case SpecEditPostWoRollback = 'spec_edit_post_wo_rollback'; // manufacturing → adjustments
