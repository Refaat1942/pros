...
class AdminReportsHubService
{
    ...
    public function sections(): array
    {
        ...
        $skip = ['overview', 'bi', 'general-view', 'reports', 'reports-section', 'permissions', 'employees', 'notifications', 'military-ranks', 'military-debts', 'costing-settings', 'pathway-settings'];
