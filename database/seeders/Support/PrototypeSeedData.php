...
class PrototypeSeedData
{
  ...
  {
    return [
      ['id' => 'QT-PENDING-001', 'orderRef' => 'ORD-2026-0847', 'patient' => 'محمود عبد الرحمن', 'company' => 'التأمين الوطني', 'date' => '08/06/2026', 'items' => 3, 'doctor' => 'د. سارة عبدالله', 'recommendations' => [['name' => 'ركبة هيدروليكية', 'code' => 'ITM-001', 'qty' => 1], ['name' => 'قدم Carbon Spring', 'code' => 'ITM-003', 'qty' => 1], ['name' => 'بطانة Silicone', 'code' => 'ITM-004', 'qty' => 1]], 'patientType' => 'civilian', 'statusKey' => 'pending', 'statusLabel' => 'في انتظار موافقة الأدمن', 'step' => 1, 'approvedAt' => null, 'approvedBy' => null],
      ['id' => 'QT-PENDING-002', 'orderRef' => 'ORD-2026-0845', 'patient' => 'فاطمة حسين محمد', 'company' => 'التأمين الصحي', 'date' => '07/06/2026', 'items' => 2, 'doctor' => 'د. سارة عبدالله', 'recommendations' => [['name' => 'ركبة Polycentric', 'code' => 'ITM-002', 'qty' => 1], ['name' => 'Pin Lock', 'code' => 'ITM-006', 'qty' => 1]], 'patientType' => 'civilian', 'statusKey' => 'pending', 'statusLabel' => 'في انتظار موافقة الأدمن', 'step' => 1, 'approvedAt' => null, 'approvedBy' => null],
      ['id' => 'QT-PENDING-003', 'orderRef' => 'ORD-2026-0839', 'patient' => 'مريم خالد إبراهيم', 'company' => 'مصر للتأمين', 'date' => '07/06/2026', 'items' => 2, 'doctor' => 'د. سارة عبدالله', 'recommendations' => [['name' => 'قدم Carbon Spring', 'code' => 'ITM-003', 'qty' => 1], ['name' => 'جوارب تجويف', 'code' => 'ITM-009', 'qty' => 1]], 'patientType' => 'civilian', 'statusKey' => 'sent', 'statusLabel' => 'معتمد — جاهز لعرض السعر', 'step' => 2, 'approvedAt' => '07/06/2026 14:30', 'approvedBy' => 'أحمد محمود'],
    ];
  }
