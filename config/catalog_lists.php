...
return [
    ...
    'profiles' => [
        ...
        'adjustments_catalog' => [
            'label_ar' => 'جدول الأصناف — المعدلات',
            'dashboard' => 'adjustments',
            'page' => 'catalog',
            'default_roles' => ['adjustments'],
            'default_columns' => ['code', 'name', 'brand', 'uom', 'available', 'status'],
        ...
        'workshop_catalog' => [
            'label_ar' => 'جدول الأصناف — قسم الإنتاج',
            'dashboard' => 'workshop',
            'page' => 'catalog',
            'default_roles' => ['workshop'],
            'default_columns' => ['code', 'name', 'brand', 'uom', 'available', 'status'],
        ],
        'doctor_picker' => [
    ...
    'required_columns' => [
        ...
        'spec_catalog' => ['code', 'name'],
        'adjustments_catalog' => ['code', 'name'],
        'workshop_catalog' => ['code', 'name'],
