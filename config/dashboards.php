        ...
        'pages' => [
            ...
            'stock-kits' => [
                ...
                'assistant' => [
                    ...
                    'answer' => 'من هنا تُعرَّف الأطقم الجاهزة والمخصصات: ابحث عن الأصناف بالاسم (مثل ركبة) وأضف أكثر من مكوّن. الطقم يظهر في التوصيف والمعدلات ويُفكّك تلقائياً لمكوّناته.',
                    'steps' => [
                        'اضغط «إضافة طقم».',
                        'اكتب اسم الطقم (مثال: طقم ركبة كاملة).',
                        'في مربع البحث اكتب اسم الصنف — اختر من النتائج وأضف أكثر من صنف.',
                        'حدّد الكمية لكل مكوّن ثم احفظ.',
                    ],
                ],
            ],
