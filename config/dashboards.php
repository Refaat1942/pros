...
return [
    ...
    'adjustments' => [
        'title' => 'لوحة المعدلات والتكاليف — مركز الأطراف الصناعية',
        'layout' => 'layouts.adjustments',
        'default_page' => 'adjustments',
        'sidebar' => ['icon' => '📏', 'title' => 'المعدلات والتكاليف', 'subtitle' => 'تجارب التركيب والمقاسات'],
        'pages' => [
            'adjustments' => ['title' => 'المعدلات والتكاليف', 'icon' => '📏', 'label' => 'المعدلات والتكاليف'],
